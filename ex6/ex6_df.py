...
joined_df = lapd.join(filtered_df, lapd["PREC"] == filtered_df["AREA"])
...
joined_df = lapd.join(filtered_df2, lapd["PREC"] == filtered_df["AREA"])
# Keep specific columns in the result
...
joined_df = filtered_df.crossJoin(lapd)
...
joined_df2 = filtered_df2.crossJoin(lapd)
